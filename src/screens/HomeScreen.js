    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={[styles.sliderContainer, { height: sliderHeight }]}>
        <FlatList
          ...
          renderItem={({ item }) => (
            <Image
              source={{ uri: item.uri }}
              style={{ width: screenWidth, height: sliderHeight }}
              resizeMode="cover"
            />
          )}
        />
      ...
      <View style={styles.card}>
        ...
        <View style={styles.quickGrid}>
          ...
          <QuickLink icon="hand-left" label="Prayer" onPress={() => navigation.navigate('MoreTab', { screen: 'Prayer', initial: false })} color="#9C27B0" />
          <QuickLink icon="call" label="Contact" onPress={() => navigation.navigate('MoreTab', { screen: 'Contact', initial: false })} color="#4CAF50" />
          <QuickLink icon="people" label="Connect" onPress={() => navigation.navigate('MoreTab', { screen: 'Connection', initial: false })} color="#00BCD4" />
          <QuickLink icon="calendar" label="Events" onPress={() => navigation.navigate('MoreTab', { screen: 'Events', initial: false })} color="#2196F3" />
        </View>
      </View>
